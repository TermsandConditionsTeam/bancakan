	...
	function email_check(){	
		...
		if(email == "" || email.length < 4){
			$('#email').css('border', '3px red solid');
			 $('div#ff form#fm #subsub').attr('disabled', true);  
		}
		else
		{
			jQuery.ajax({
				...
				else
				{
					...
					$('div#ff form#fm #subsub').attr('disabled', false);  	
				}
...
<div class="container">
	...
	<div id="ff" style="border:2px solid;border-radius: 10px;width:500px;padding:10px 20px;background:#76421c;margin:auto;">
		<form id="fm" name="regist" action="register.php" autocomplete="off" role="form" method="post">

<div class="container">
    <div id="map_jelajah">
        ...
        <div id="myModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div style="height:auto;min-height:400px;margin-left:33px;margin-top:10%;" class="modal-content">
                <!-- <div class="modal-content"> -->
                    <div style="background: #21B6A8;margin-left:33px;border-radius: 3px 3px 0px 0px; " class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                    <!-- <div style="background:#21B6A8;" class="navbar navbar-inverse navbar-fixed-top" role="navigation"> -->
                        <div class="container-fluid">
                            <div class="navbar-header">
                                <a id="nameBudaya" style="color:white; font-weight:bold;" class="navbar-brand" href="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
    ...
    <script>
        ...
        var southWest = L.latLng(-6.99888,107.47473),
            ...
            var map = L.mapbox.map('map_jelajah', 'rifqithomi.jb5ibjeg',{
                maxBounds: bounds,
                minZoom:11
            })
            ...
            myLayer.on('click',function(e){
                ...
                {   
                    ...
                    $('#nameBudaya').html(e.layer.feature.properties.city+"&nbsp;<a style='font-size:10px; width:70px;height:25px;padding:2px;color:white;font-weight:bold;' id='detBud' href='#'class='btn'>Lihat detail</a>");
                    $('#myModal').modal('show'); 
